...
create table Sales
(SalesId nvarchar(50) primary key,
...
values ('SId-001','P-001',2,24000,'2025-11-17'),
...
('SId-008','P-008',3,17400,'2025-09-10')
select * from Sales

select s.SalesId,s.SalesDate,p.ProductId,p.ProductName,p.Category,s.Quantity,p.UnitPrice,s.TotalAmount
